...
export default {
  ...
  methods: {
    displaySideBar() {
      this.$store.dispatch('app/displaySideBar', !this.$store.state.app.sidebar.show)
    },

    displaySideBarLogo() {
      this.$store.dispatch('app/displaySideBarLogo', !this.$store.state.app.sidebar.logo)
    },
    ...
    displayTagsView() {
      this.$store.dispatch('app/displayTagsView', !this.$store.state.app.header.tagsView)
    },

    fixedHeader() {
      this.$store.dispatch('app/fixedHeader', !this.$store.state.app.header.fixed)
    },
  },
}
</script>
